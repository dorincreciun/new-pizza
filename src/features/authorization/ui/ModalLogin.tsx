...
import {useRegisterModal} from "../model/store/register-store.ts";

export const ModalLogin = () => {
    const isOpen = useLoginModal((s) => s.isOpen)
    const fnCloseLogin = useLoginModal((s) => s.close)
    const fnOpenRegister = useRegisterModal((s) => s.open)
